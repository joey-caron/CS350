...
class TemperatureMachine(StateMachine):
    ...
    def setupSerialOutput(self):
        ...
        output = f"S:{self.current_state.id},T:{self.getFahrenheit():0.1f}F,Set:{self.setPoint}F"
    ...
    def manageMyDisplay(self):
        ...
        while not self.endDisplay:
            ...
            if(altCounter < 6):
                line2 = f"T:{self.getFahrenheit():0.1f}F"
                
    
                altCounter = altCounter + 1
            else:
                line2 = f"S:{self.current_state.id} Set:{self.setPoint}F"
